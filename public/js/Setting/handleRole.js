...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/tom-select/dist/css/tom-select.css":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/tom-select/dist/css/tom-select.css ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_tom_select_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!../../../postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./tom-select.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/tom-select/dist/css/tom-select.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_tom_select_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_tom_select_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
"use strict";
/*!********************************************!*\
  !*** ./resources/js/Setting/handleRole.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('DOMContentLoaded', function () {
  var userSelect = document.querySelector('#userName');
  if (userSelect) {
    new tom_select__WEBPACK_IMPORTED_MODULE_1__["default"](userSelect, {
    ...
    setTimeout(function () {
      ...
      (_document$querySelect = document.querySelector('.ts-control')) === null || _document$querySelect === void 0 || _document$querySelect.style.setProperty('height', '37px');
    }, 0);
  }
});
document.addEventListener('DOMContentLoaded', function () {
  var assignAllBtn = document.getElementById('assignAllBtn');
  assignAllBtn.addEventListener('click', function () {
    var role = document.getElementById('bulkRole').value;
    if (!role) {
      toastr__WEBPACK_IMPORTED_MODULE_3___default().warning('Vui lòng chọn quyền!');
      return;
    }
    fetch('/add_all_role_manager', {
      ...
      if (data.success) {
        toastr__WEBPACK_IMPORTED_MODULE_3___default().success(data.message);
        var tableBody = document.getElementById('roleUserTableBody');

        // Xóa dòng "Chưa có dữ liệu" nếu có
        var emptyRow = tableBody.querySelector('.text-muted');
        if (emptyRow) {
        ...
        data.users.forEach(function (user, index) {
          ...
          tr.innerHTML = "\n                        <td style=\"text-align: center\">".concat(currentCount + index + 1, "</td>\n                        <td style=\"text-align: center\">").concat(user.name, "</td>\n                        <td style=\"text-align: center\">").concat(user.role, "</td>\n                        <td style=\"text-align: center\">\n                            <button class=\"btn btn-danger btn-sm delete-role-user\" data-id=\"").concat(user.pivot_id, "\">\n                                Xo\xE1\n                            </button>\n                        </td>\n                    ");
          tableBody.appendChild(tr);
        });
      } else {
        toastr__WEBPACK_IMPORTED_MODULE_3___default().error(data.message || 'Đã có lỗi xảy ra');
      }
    })["catch"](function (error) {
      console.error('Lỗi:', error);
      toastr__WEBPACK_IMPORTED_MODULE_3___default().error('Lỗi hệ thống!');
    });
  });
        ...
        if (result.isConfirmed) {
          fetch('/delete_role_manager', {
            ...
            if (data.success) {
              ...
              // Xoá dòng
              (_e$target$closest = e.target.closest('tr')) === null || _e$target$closest === void 0 || _e$target$closest.remove();

              // Nếu bảng trống → thêm dòng "chưa có dữ liệu"
              var tableBody = document.getElementById('roleUserTableBody');
              if (tableBody.querySelectorAll('tr').length === 0) {
                var emptyRow = document.createElement('tr');
                emptyRow.innerHTML = "\n                                    <td colspan=\"4\" class=\"text-center text-muted\">Ch\u01B0a c\xF3 d\u1EEF li\u1EC7u ph\xE2n quy\u1EC1n</td>\n                                ";
                tableBody.appendChild(emptyRow);
              }
            } else {
              toastr__WEBPACK_IMPORTED_MODULE_3___default().warning(data.message || 'Không thể xoá phân quyền.');
            }
          })["catch"](function (error) {
            console.error('Lỗi:', error);
            toastr__WEBPACK_IMPORTED_MODULE_3___default().error('Lỗi hệ thống!');
  ...
  var addBtn = document.getElementById('addRoleUser');
  ...
  addBtn.addEventListener('click', function () {
    ...
    if (!userId || !roleId) {
      toastr__WEBPACK_IMPORTED_MODULE_3___default().warning('Vui lòng chọn người dùng và quyền!');
      return;
    }
    fetch('/add_role_manager_single', {
      ...
      if (data.success) {
        ...
        var currentCount = tableBody.querySelectorAll('tr').length;
        var tr = document.createElement('tr');
        tr.innerHTML = "\n                    <td style=\"text-align: center\">".concat(currentCount + 1, "</td>\n                    <td style=\"text-align: center\">").concat(data.user.name, "</td>\n                    <td style=\"text-align: center\">").concat(data.user.role, "</td>\n                    <td style=\"text-align: center\">\n                        <button class=\"btn btn-danger btn-sm delete-role-user\" data-id=\"").concat(data.user.pivot_id, "\">\n                            Xo\xE1\n                        </button>\n                    </td>\n                ");
        tableBody.appendChild(tr);
        document.getElementById('userName').value = '';
      } else {
        toastr__WEBPACK_IMPORTED_MODULE_3___default().warning(data.message || 'Không thể thêm phân quyền.');
      }
    })["catch"](function (error) {
      console.error('Lỗi:', error);
      toastr__WEBPACK_IMPORTED_MODULE_3___default().error('Lỗi hệ thống!');
