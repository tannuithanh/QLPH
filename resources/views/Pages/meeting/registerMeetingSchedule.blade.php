                    ...
                    <h5 class="mb-4 title-vinhgia">Thông tin lịch họp</h5>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="moderator" placeholder="Nhập tên người chủ trì">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="result_record_location" required>
                                    ...
                                    <option value="CAP tại biên bản báo cáo sự không phù hợp">CAP tại biên bản báo cáo sự không phù hợp</option>
                                </select>
                            </div>
                        </div>

                        <div class="mt-4 text-end">
                            <button type="button" id="registerSchedule" class="btn text-white px-4" style="background-color: #C06252;">
